  ...
  if (avg_packed_qo_len > 64 && head_dim < 256) {
    ...
    if (compute_capacity.first >= 8) {
      ...
      if (avg_packed_qo_len > 16) {
        ...
        // step costs (qk+vo)*16*4*sizeof(dtype); at (512,256) that exceeds the
        // ~100KB/SM budget of CC 12.x consumer Blackwell and would yield the
        // unrecoverable "Unsupported max_mma_kv: 0" dispatch failure. Fall back
        // to cta_tile_q=64 (4x1 layout, 4x cheaper KV step). sizeof assumed 2.
